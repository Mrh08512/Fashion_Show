...
- (id)initWithFrame:(CGRect)frame
{
    if ((self = [super initWithFrame:frame])) {
        ...
        UILongPressGestureRecognizer *longPressTap = [[UILongPressGestureRecognizer alloc] initWithTarget:self action:@selector(longPressGestureTap:)];
...
- (void)longPressGestureTap:(UILongPressGestureRecognizer *)tap
{
    _doubleTap = NO;
    
    if ([self.photoViewDelegate respondsToSelector:@selector(longTapPhotoFinish:)])
    {
        [self.photoViewDelegate longTapPhotoFinish:self];
    }
}
